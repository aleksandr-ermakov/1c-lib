...
Функция СвернутьТаблицуЗначений(Знач ТаблицаЗначений, Измерения = "", Ресурсы = "") Экспорт
	...
	Иначе
		...
		ВызватьИсключение "Параметр Измерения: Ожидается Строка, СписокЗначений, Структура, Соответствие";
	...
	Иначе
		ВызватьИсключение "Параметр Ресурсы: Ожидается Строка, СписокЗначений, Структура, Соответствие"; 
