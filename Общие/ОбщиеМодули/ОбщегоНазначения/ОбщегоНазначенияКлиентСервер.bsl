...
// Позволяет из строкового перечисления типов сформировать объект ОписаниеТипов
//
// Параметры:
//	ОписаниеТиповСтрокой - Строка - Строка с перечислением типов.
//		Типы разделяются точкой с запятой или переводом строки.
//		Пример: "Число(24, 2, Неотрицательный); СправочникСсылка.Номенклатура"
//		Параметры квалификаторов можно записывать как в полной, так и в краткой форме.
//		Например, "Число(12, 2, ДопустимыйЗнак.Неотрицательный)" равнозначно "Число(24, 2, Неотрицательный)"
//
// Возвращаемое значение:
//	ОписаниеТипов - Полученное описание типов.
//
Функция ОписаниеТиповПоСтроке(ОписаниеТиповСтрокой) Экспорт
	
	Подстроки = СтрРазделить(ОписаниеТиповСтрокой, ";" + Символы.ПС);
...
// Позволяет из строкового описания типа сформировать объект ОписаниеТипов
//
// Параметры:
//	ОписаниеТиповСтрокой - Строка - Строка с описанием типа.
//		Пример: "Число(24, 2, Неотрицательный)"
//		Параметры квалификаторов можно записывать как в полной, так и в краткой форме.
//		Например, "Число(12, 2, ДопустимыйЗнак.Неотрицательный)" равнозначно "Число(24, 2, Неотрицательный)".
//
// Возвращаемое значение:
...
Функция ОписаниеТипаПоСтроке(Знач ОписаниеТипаСтрокой) Экспорт
	...
	Если ПараметрыСтроками.Количество() = 0 Тогда
