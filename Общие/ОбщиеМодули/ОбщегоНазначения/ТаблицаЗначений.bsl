...
Функция ПроверитьУникальностьЗначенийТаблицы(ТаблицаЗначений, Колонки, НеуникальныеЗначения = Неопределено) Экспорт
	...
	ПроверочнаяТаблица.Колонки.Добавить("Количество", Новый ОписаниеТипов("Число"));
	ПроверочнаяТаблица.Свернуть(Колонки, "Количество");
	...
	Возврат ЗначениеЗаполнено(НеуникальныеЗначения); 
