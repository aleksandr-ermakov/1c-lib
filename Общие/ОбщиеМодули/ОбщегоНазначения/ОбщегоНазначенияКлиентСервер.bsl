...
//
// Варианты вызова:
//	ОбъединениеОписанийТипов(ОписаниеТипов, ОписаниеТипов, ...) - Объединение указанных отдельно описаний типов.
//	ОбъединениеОписанийТипов(Массив) - Объединение типов, переданных в массиве.
//
Функция ОбъединениеОписанийТипов(ОписаниеТиповА, ОписаниеТиповБ = Неопределено) Экспорт
...
Функция ОписаниеТиповПоСтроке(Знач ОписаниеТиповСтрокой, Знач Разделитель = ";") Экспорт
	...
	ОписаниеТипов = ОбъединениеОписанийТипов(ВсеОписанияТипов);
