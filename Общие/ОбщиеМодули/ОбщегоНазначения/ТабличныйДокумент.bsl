...
// Заполняет расшифровку ячеек табличного документа по данным расшифровки.
// Применяется, если табличный документ получен компоновкой данных, и требуется обеспечить открытие значений ячеек.
//
// Параметры:
//	ТабличныйДокумент - ТабличныйДокумент
//	ДанныеРасшифровки - ДанныеРасшифровкиКомпоновкиДанных
//
Процедура ЗаполнитьРасшифровкуЯчеекТабличногоДокументаПоДаннымРасшифровки(ТабличныйДокумент, ДанныеРасшифровки) Экспорт
	...
	Для НомерСтроки = 1 По ТабличныйДокумент.ВысотаТаблицы Цикл
		Для НомерКолонки = 1 По ТабличныйДокумент.ШиринаТаблицы Цикл
			...
			Если ТипЗнч(Ячейка.Расшифровка) <> Тип("ИдентификаторРасшифровкиКомпоновкиДанных") Тогда
				Продолжить;
			КонецЕсли;		
			ЭлементРасшифровки = ЭлементыРасшифровки[Ячейка.Расшифровка];
...
//
Процедура СгруппироватьТабличныйДокументПоЗначениямКолонки(ТабличныйДокумент, НомерКолонки, ВысотаЗаголовка = 0) Экспорт
