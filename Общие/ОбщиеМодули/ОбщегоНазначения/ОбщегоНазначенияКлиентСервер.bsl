...
//							Должен быть положительным числом, не превышающим количество секунд в сутках.
...
Функция ОкруглитьВремя(ДатаВремя, ШагСекунд, Режим = 1) Экспорт
	...
	НачалоДня = НачалоДня(ДатаВремя);
	Секунд = ДатаВремя - НачалоДня;
	
	Результат = НачалоДня + Секунд - Секунд % ШагСекунд;	// Округление вниз
	Результат = Результат + ШагСекунд * Окр((Секунд % ШагСекунд) / ШагСекунд, 0, Режим);
