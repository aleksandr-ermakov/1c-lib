...
// Возвращает первый запрос выбора из схемы запроса.
//
// Параметры:
//  СхемаЗапроса - СхемаЗапроса - Схема, в которой производится поиск
//
// Возвращаемое значение:
//  ЗапросВыбораСхемыЗапроса, Неопределено - Первый запрос выбора или Неопределено, если запрос отсутствует.
//
Функция ПервыйЗапросВыбораСхемыЗапроса(СхемаЗапроса) Экспорт
...
//
// Параметры:
//  ЗапросВыбора - ЗапросВыбораСхемыЗапроса - Запрос выбора, из которого будет получен первый оператор выбора схемы запроса.
//
// Возвращаемое значение:
//  - ОператорВыбратьСхемыЗапроса - Найденный оператор.
