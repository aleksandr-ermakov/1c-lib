...
Функция КодЦвета(Знач Цвет, Префикс = "#", Кратко = Ложь) Экспорт
	...
	Иначе
		...
		Числа = Новый Соответствие;	// Так быстрее работает.
		Числа[0] = "0";
		Числа[1] = "1";
		Числа[2] = "2";
		Числа[3] = "3";
		...
		Если Кратко 
			...
			КодЦвета = Числа[РазрядыЧислами[0]]
					+ Числа[РазрядыЧислами[2]] 
					+ Числа[РазрядыЧислами[4]];

		Иначе

			КодЦвета = "";
			Для Каждого РазрядЧислом Из РазрядыЧислами Цикл
				КодЦвета = КодЦвета + Числа[РазрядЧислом];
			КонецЦикла;
