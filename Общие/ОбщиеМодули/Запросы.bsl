...
//
Функция ДобавитьИсточникСхемыЗапроса(Знач Источники, Знач ИмяТаблицы, Знач Псевдоним = "") Экспорт
	Если Ложь Тогда 
		Источники = Новый ИсточникиСхемыЗапроса;
		ИмяТаблицы = "ИмяТаблицы";
		Псевдоним = "Псевдоним";
	КонецЕсли;

	ИсточникСхемы = Источники.Добавить(Тип("ОписаниеВременнойТаблицыСхемыЗапроса"), ИмяТаблицы, Псевдоним);
...
//
// Параметры: 
//	ОператорВыбрать - ОператорВыбратьСхемыЗапроса - Оператор запроса, в котором нужно изолировать источник.
//	Источник - ИсточникСхемыЗапроса - Источник, который нужно изолировать.
//	
Процедура ИзолироватьИсточникСхемыЗапроса(ОператорВыбрать, Источник) Экспорт

	Источник.Соединения.Очистить(); // От источника к другим таблицам
	
	// От других таблиц к источнику:
	Для каждого ТекущийИсточник Из ОператорВыбрать.Источники Цикл
