...
//	ДополнительноеОписаниеТипов	 - ОписаниеТипов - Описание типов.
//
...
//
Функция ОбъединитьОписанияТипов(ОписаниеТипов, ДополнительноеОписаниеТипов = Неопределено) Экспорт

	Если ТипЗнч(ОписаниеТипов) = Тип("Массив") Тогда
		МассивОписаний = ОписаниеТипов;
	ИначеЕсли ТипЗнч(ОписаниеТипов) = Тип("ОписаниеТипов") Тогда
		Если ТипЗнч(ДополнительноеОписаниеТипов) <> Тип("ОписаниеТипов") Тогда
			ВызватьИсключение "Параметр ДополнительноеОписаниеТипов: Ожидается тип ОписаниеТипов.";
		КонецЕсли;
		МассивОписаний = Новый Массив(2);
		МассивОписаний[0] = ОписаниеТипов;
		МассивОписаний[1] = ДополнительноеОписаниеТипов;
	Иначе
