...
//  Булево
//
Функция ЭтоУникальныйИдентификатор(Строка, ДопускатьСкобки = Ложь) Экспорт
...
Функция УникальныйИдентификаторВШестнадцатеричноеЧисло(Знач УникальныйИдентификатор, ДобавитьПрефикс = Истина)
	...
	КоличествоЧастейИдентификатора = 5;
	Если СоставныеЧасти.Количество() <> КоличествоЧастейИдентификатора Тогда 
		Возврат Неопределено;
	КонецЕсли; 	
