...
//   - 
//
Функция ПреобразоватьВыражениеПоляИзФорматаСКД(Знач Выражение, Отказ = Ложь) Экспорт
...
//
Функция НайтиНаборыДанныхПоИсточникуДанных(НаборыДанных, ИмяОбъекта) Экспорт
...
//   НаборДанныхОбъектСхемыКомпоновкиДанных, НаборДанныхОбъектМакетаКомпоновкиДанных - Если не найден - Неопределено.
//	
Функция НайтиНаборДанныхПоИсточникуДанных(НаборыДанных, ИмяОбъекта) Экспорт
