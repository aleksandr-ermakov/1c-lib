...
//  Булево
//
Функция ЭтоПримитивныйТип(Значение, СчитатьТипПримитивным = Истина) Экспорт
