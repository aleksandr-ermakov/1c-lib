...
//
Функция ИмяИзСинонима(Синоним) Экспорт
...
//
Функция СинонимИзИмени(Имя) Экспорт

	// Тестовый пример
	// Вход:	"_АаАаААааАААаааААААааааААААА_АА_ААА_123_"
	// Выход:	"Аа аа а ааа АААааа ААААаааа ААААА а а ААА 123"
	...
	Для Индекс = 0 По СинонимПоЧастям.ВГраница() Цикл
		...
		Для НомерСимволаСлова = 1 По ДлинаСлова Цикл
			...
			КонецЕсли;
		КонецЦикла;
		Если ДлинаАббревиатуры = 2 И Не (ДлинаСлова = 2 И Индекс = СинонимПоЧастям.ВГраница()) Тогда
			ТекСимвол = Лев(Слово, 1);
			СинонимПоЧастям.Вставить(Индекс, ?(Индекс = 0, ВРег(ТекСимвол), НРег(ТекСимвол)));
			Индекс = Индекс + 1;
			ДлинаАббревиатуры = ДлинаАббревиатуры - 1;
		...
		Если Не ПустаяСтрока(Слово) Тогда
			СохранитьРегистр = (ДлинаАббревиатуры > 2);
