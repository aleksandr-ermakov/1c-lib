...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("Тест_Средние");
...
Процедура Тест_Средние() Экспорт
	// Тест 1: Получение среднего элемента массива
	Массив = Новый Массив;
	Массив.Добавить(1);
	Массив.Добавить(2);
	Массив.Добавить(3);
	Массив.Добавить(4);
	Массив.Добавить(5);
	Результат = Средние(Массив, 1, 3);
	ОжидаемыйРезультат = Новый Массив;
	ОжидаемыйРезультат.Добавить(2);
	ОжидаемыйРезультат.Добавить(3);
	ОжидаемыйРезультат.Добавить(4);
	Если Результат <> ОжидаемыйРезультат Тогда
		ВызватьИсключение "Тест 1 не пройден";
	КонецЕсли;

	// Тест 2: Получение всех элементов массива
	Результат = Средние(Массив, 0, 5);
	ОжидаемыйРезультат = Новый Массив;
	ОжидаемыйРезультат.Добавить(1);
	ОжидаемыйРезультат.Добавить(2);
	ОжидаемыйРезультат.Добавить(3);
	ОжидаемыйРезультат.Добавить(4);
	ОжидаемыйРезультат.Добавить(5);
	Если Результат <> ОжидаемыйРезультат Тогда
		ВызватьИсключение "Тест 2 не пройден";
	КонецЕсли;

	// Тест 3: Получение элементов с конца массива
	Результат = Средние(Массив, 3, 2);
	ОжидаемыйРезультат = Новый Массив;
	ОжидаемыйРезультат.Добавить(4);
	ОжидаемыйРезультат.Добавить(5);
	Если Результат <> ОжидаемыйРезультат Тогда
		ВызватьИсключение "Тест 3 не пройден";
	КонецЕсли;

	// Тест 4: Получение элементов с начальной позиции до конца массива
	Результат = Средние(Массив, 2);
	ОжидаемыйРезультат = Новый Массив;
	ОжидаемыйРезультат.Добавить(3);
	ОжидаемыйРезультат.Добавить(4);
	ОжидаемыйРезультат.Добавить(5);
	Если Результат <> ОжидаемыйРезультат Тогда
		ВызватьИсключение "Тест 4 не пройден";
	КонецЕсли;

	Сообщить("Все тесты для функции Средние() пройдены");
КонецПроцедуры
