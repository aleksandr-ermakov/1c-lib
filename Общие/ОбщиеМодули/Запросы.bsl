...
//
Функция ТекстЗапросаТранзитивноеЗамыканиеСправочника(ИмяСправочника, МаксимальнаяДлинаПути = Неопределено)
...
Функция ТекстЗапросаТранзитивноеЗамыкание(ИмяТаблицы, ПолеРодитель, ПолеПотомок, 
	ВыражениеПустоеЗначение = "NULL", 
	МаксимальнаяДлинаПути = 64
	ТаблицаДляПомещения = "") Экспорт
