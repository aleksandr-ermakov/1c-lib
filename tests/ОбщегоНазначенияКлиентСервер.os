...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ОкруглитьВремя");
...
Процедура ОкруглитьВремя() Экспорт

	ИмяМетода = "ОкруглитьВремя";
	...
	Режим = 0;	// Вниз.
	Параметры = Новый Массив(1);
	Результат = Модуль.ОкруглитьВремя(Дата, ШагСекунд, Режим);
	Ожидаем
	...
	Ожидаем
		...
		// Дата = '2023-10-05 00:00:00';
	// Параметры = Новый Массив(1);
	// Параметры[0] = ДатаБезВремени;
	// Результат = Модуль.ОкруглитьВремя(ДатаБезВремени);
	// Ожидаем
	// 	.Что(Результат, "Дата без времени не изменилась")
	// 	.Равно('2023-10-05 00:00:00');
